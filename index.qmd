...
@cr-headline2 <span style="font-size: 48pt; font-weight: bold; text-align: center; color: #FFFFFF; text-shadow: 1px 1px 4px rgba(0,0,0,0.3);">AUDINET REPORT</span> 
...
@cr-headline <span style="font-size: 48pt; font-weight: bold; text-align: center; color: #FFFFFF; text-shadow: 1px 1px 4px rgba(0,0,0,0.3);">FUSIÓN TELECOM Y TELEFÓNICA</span> 
...
@cr-headline La empresa del Grupo Clarín invirtió US$ 1.245 millones para quedarse con Telefónica Argentina. 

@cr-headline La operación marca un hito histórico en el mercado argentino de telecomunicaciones. 
...
Dentro del market share previo a la fusión, Flow (Telecom) y Movistar (Telefónica) son dos de los principales players dentro del mercado @cr-market-plot-highlighted
...
viewof chart_zoomed = Plot.plot({
  ...
  marks: [
    Plot.barX(zoomed_data, {
      y: "Grupo ME",
      x: "Share pre fusion",
      fill: "#7600BF" // Keep highlight color
    }),
...
[@cr-mapa-activo]{scale-by="7.4"} Según el relevamiento de Fabric, Movistar tiene actualmente presencia en 14 provincias.

[@cr-mapa-concentracion]{scale-by="16.8"} El 81% de sus abonados se concentran en CABA, Buenos Aires y Mendoza.

@cr-barras-provincias El 81% de sus abonados se concentran en CABA, Buenos Aires y Mendoza.
...
[@cr-mapa-patagonia]{scale-by="7.4"} Las provincias donde Movistar tiene una posición más dominante en el market share se encuentran en la región patagónica.
...
[@cr-mapa-fusion]{scale-by="7.6"} Hoy en día Flow es <span style="color:#FFAC26">**LÍDER DE MERCADO**</span> en 13 de esas provincias.
...
[@cr-barras-flow-post]{scale-by="0.9"} Tras la fusión, el Market Share de Flow en dichas provincias se vería así. En distritos como CABA (53.9%), Neuquén (46.7%), San Juan (51.2%) y Río Negro (54.8%), la empresa de Telecom pasaría a tener una posición totalmente dominante.
