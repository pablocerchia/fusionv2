...
@cr-headline <span style="font-size: 48pt; font-weight: bold; text-align: center; color: #171a1f; text-shadow: 1px 1px 4px rgba(0,0,0,0.3);">FUSIÓN TELECOM Y TELEFÓNICA</span> 

@cr-headline <span style="font-size: 38pt; font-weight: bold; text-align: center; color: #171a1f; ">¿Cómo impacta al mercado de Internet?</span> 
...
Un detalle más cercano a estos dos competidores: @cr-market-plot-zoomed
...
@cr-barras-provincias La distribución de abonados muestra una clara concentración en tres provincias principales.
...
[@cr-mapa-patagonia]{scale-by="7.4"} Las provincias donde Movistar tiene una posición más dominante en el market share se encuentran en la región patagonica.
...
[@cr-barras-agrupadas]{scale-by="0.9"} Veámos en detalle el impacto de la fusión en el Market Share de Flow.  


[@cr-barras-comparacion]{scale-by="0.9"} Este sería el impacto de la fusión en el Market Share de Flow si le sumamos el Share de Movistar en las provincias que ambas comparten cobertura.

[@cr-barras-flow-post]{scale-by="0.9"} Tras la fusión, el Market Share de Flow en dichas provincias se vería así. En distritos como CABA, Neuquén, San Juan y Río Negro, la empresa de Telecom pasaría a tener una posición totalmente dominante.
...
[@cr-nacional-share]{scale-by="0.9"} A nivel nacional, Flow lidera el mercado con un 34.7% de participación, seguido por otros operadores con 18.9%. Movistar, que será adquirida por Flow, actualmente tiene un 12.9% del mercado.
...
[@cr-nacional-share-post]{scale-by="0.9"} Tras la fusión, Flow alcanzará un 47.5% del mercado nacional, consolidándose como el líder indiscutido del sector. El siguiente competidor más cercano mantendrá un 18.9% de participación.
